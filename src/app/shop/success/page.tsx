  ...
  return (
    ...
    >
      <div
        ...
        aria-hidden
        style={{ background: "radial-gradient(circle at 50% 40%, rgba(58, 125, 140, 0.06), transparent 55%)" }}
      />
      <div className="relative z-10 max-w-3xl mx-auto px-6 sm:px-12 lg:px-16 w-full">
        <RevealOnView className="kiln-card-surface border border-white/10 bg-white/[0.02] p-8 sm:p-10" blur>
          <div className="flex items-center gap-3 mb-4">
            <span className="kiln-badge-pulse inline-block w-2 h-2 rounded-full bg-[#3A7D8C]" />
            <p className="text-[10px] tracking-[0.3em] text-[#3A7D8C] uppercase">
              Resolved
            </p>
          </div>
          <h1
          ...
          <p className="text-white/55 leading-relaxed mb-8">
            Your order was completed successfully. If delivery is automated for this item, details
            should arrive in your email shortly.
          </p>
          <div className="flex flex-wrap items-center gap-6">
            ...
            <Link
              href="/intake"
              className="kiln-link-surface text-[10px] tracking-[0.2em] text-white/50 uppercase hover:text-white transition-colors duration-300"
            >
              Make contact
            </Link>
          </div>
